      ...
      <form method="post" action="{{ url('/login') }}">
        ...
        <div class="form-group has-feedback {{ $errors->has('email') ? ' has-error' : '' }}">
          ...
          <div class="form-group has-feedback{{ $errors->has('password') ? ' has-error' : '' }}">
            <input type="password" class="form-control" placeholder="{{__('auth.psswd')}}" name="password">
          ...
          <div class="row">
            <div class="col-xs-7">
              <div class="checkbox icheck">
                <label>
                  <input type="checkbox" name="remember"> {{__('auth.stay_log')}}
                </label>
              </div>
            </div>
            <!-- /.col -->
        ...
        <a href="{{ url('/password/reset') }}">{{__('auth.psswd_forget')}}</a><br>
        <a href="{{ url('/register') }}" class="text-center">{{__('auth.sign_up')}}</a>
