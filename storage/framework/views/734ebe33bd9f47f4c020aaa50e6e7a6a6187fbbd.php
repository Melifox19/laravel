...
<body class="skin-blue sidebar-mini">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        ...
                                        <small>Membre depuis <?php echo Auth::user()->created_at->format('M. Y'); ?></small>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
    ...
    <footer class="main-footer" style="max-height: 100px;text-align: center">
        <strong>Copyright © 2019 <a href="#">Lycée Alfred Kastler 33400 Talence</a>.</strong> All rights reserved.
    </footer>
...
<nav class="navbar navbar-default navbar-static-top">
    ...
    <div class="collapse navbar-collapse" id="app-navbar-collapse">
        <!-- Left Side Of Navbar -->
        <ul class="nav navbar-nav">
            <li><a href="<?php echo url('/home'); ?>">Acceuil</a></li>
        </ul>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="<?php echo url('/register'); ?>">S'enregistrer</a></li>
        </ul>
    </div>
</div>
</nav>
